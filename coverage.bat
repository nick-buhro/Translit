ECHO OFF
%USERPROFILE%\.nuget\packages\opencover\4.6.519\tools\OpenCover.Console.exe -register:administrator "-filter:+[NickBuhro.Translit]* -[*Tests]*" "-target:%USERPROFILE%\.nuget\packages\xunit.runner.console\2.4.0\tools\net461\xunit.console.exe" "-targetargs:.\NickBuhro.Translit.Tests\bin\Debug\net461\NickBuhro.Translit.Tests.dll -noshadow"
